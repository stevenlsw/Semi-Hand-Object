...
class ManoLayer(Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            scale_factor: scale_factor to convert output, default None
        """
        super().__init__()
        ...
        # Get hand mean
        hands_mean = np.zeros(hands_components.shape[1]) if flat_hand_mean \
    ...
    def forward(self,
        ...
        centers on root joint (9th joint)
        """
        ...
        # Consistent with Manopth and HO3D Dataset
        ...
        # convert output
        if not self.training and self.scale_factor is not None:
